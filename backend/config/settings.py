"""
Django settings for TimeTracker application.

This configuration follows SOLID principles:
- Single Responsibility: Each settings module has a specific purpose
- Open/Closed: Extensible through environment variables
- Interface Segregation: Focused configuration groups
"""
...
MAX_ORGANIZATIONS_PER_USER = env.int('MAX_ORGANIZATIONS_PER_USER', default=5)
